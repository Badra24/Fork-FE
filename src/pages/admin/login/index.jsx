import {
    ...
    InputRightAddon, FormControl, FormLabel, Input, useToast, FormHelperText,Flex
  } from '@chakra-ui/react';
  import Image from 'next/image';
import Logo from "../../../assets/imgs/logo2.png"
  import { IoMdEye, IoMdEyeOff } from 'react-icons/io';
  import ForgotPass from "../../../Component/User/auth/ForgotPass";
  ...
  export default function LoginForm() {
    ...
    const formik = useFormik({
      ...
      validationSchema: Yup.object().shape({
        ...
        .min(5, 'UsernameEmail should be of man 8 characters length')
        ,
    ...
    return (
      ...
      url={url} type="website">
          ...
          <Flex minH={'100vh'} align={'center'} justify={'center'}  backgroundPosition='center'
            ...
            <Stack display='flex' maxW={'350px'} justifyContent={'center'} bg='#ffffff' boxShadow='md' borderWidth='1px' borderRadius="3" rounded={"15"}>
              ...
              <Stack align={"center"}>
                ...
                <Box align={"center"}>
                  ...
                  <Button w={'250px'}  bg="#00A8B5" colorScheme='white' onClick={ () => {
                    formik.handleSubmit()
                  }} >Log In</Button>
                </Box>
              </Stack>
