import {
    ...
    , useToast, GridItem , ModalBody, FormLabel, ModalContent, ModalHeader,
    ModalCloseButton, Input,  FormControl, ModalOverlay,Modal, Image,Select, Td
...
// import { Select } from 'chakra-react-select';
  ...
  const formik = useFormik({
    ...
    onSubmit: async () =>{
      ...
      // const Arr_cat = [] 
        ...
        //   Arr_cat.push(formik.values.id_category1,formik.values.id_category2)
        // }
        ...
        try{
          let body = {
            ...
            await axiosInstance.patch(`/product_category/update/` + idPro , qs.stringify(body) ).then(()=>{
              console.log(idPro);
              dispatch({
                type: "RENDER_DATA",
                payload:{
  ...
  useEffect(()=>{
    ...
    return (
      ...
      onChange={(e)=>{
       index = index +1;
        formik.setFieldValue('id_category' + (index), e.target.value)
    }}>
        {category?.map ((cat) => (
          cat.id === val.id?
