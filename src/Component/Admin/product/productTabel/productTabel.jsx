          ...
          <Table variant='simple' >
            ...
            <Thead>
              <Tr bg={"#E1E1F7"} >
                ...
                <Icon as={FaSort} /></Th>
                <Th isNumeric>Primary Stock
                <Icon as={FaSort} /></Th>
                <Th isNumeric>Primary Unit
                <Icon as={FaSort} /></Th>
                <Th isNumeric>Secondary Stock
                <Icon as={FaSort} /></Th>
                <Th isNumeric>Secondary Stock
                <Icon as={FaSort} /></Th>
                <Th isNumeric>Unit Convertion
                <Icon as={FaSort} /></Th>
            ...
            <Tbody>
              ...
              {product?.map((product,index)=>(
                ...
                <Td>RP.{product.Product_Stock?.capital_price?.toLocaleString('id-ID')}</Td>
                <Td>RP.{product.Product_Stock?.profit.toLocaleString('id-ID')}</Td>
                <Td>Rp.{product.Product_Stock?.selling_price?.toLocaleString('id-ID')}</Td>
                <Td>{product.Product_Stock?.sold_qty?.toLocaleString('id-ID')}</Td>
                <Td>{product.Product_Stock?.primary_stock?.toLocaleString('id-ID')}</Td>
                <Td>{product.Product_Stock?.primary_unit?.toLocaleString('id-ID')}</Td>
                <Td>{product.Product_Stock?.secondary_stock?.toLocaleString('id-ID')}</Td>
                <Td>{product.Product_Stock?.secondary_unit?.toLocaleString('id-ID')}</Td>
                <Td>{product.Product_Stock?.unit_convertion?.toLocaleString('id-ID')}</Td>
