...
export default function NavBar() {
  ...
  return (
    <>
      ...
      <Box  bg='#ffffff' borderBottomWidth='1px'  px={4} className='topnavbar' rounded={"lg"} >
          ...
          <Flex alignItems={'center'}>
            <HStack
              ...
              {/* {Links.map((link) => (
                ...
                <Button background='white'
                  style={filter.category == 'Man’s Health' ? { textDecoration: "none", borderBottomWidth: '3px', borderBottomColor: '#3B9AE1' }
                    : { textDecoration: "none" }}
                  _hover={{ background: '#E8F5FD', color: '#00ACEE', borderBottomWidth: '3px', borderBottomColor: '#3B9AE1' }} borderRadius={0} h={16}
                  onClick={() => {
                    handleClick('Man’s Health');
                  }}>
                  Man Health
                </Button>
                <Button background='white'
