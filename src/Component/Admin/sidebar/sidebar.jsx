...
<LinkNext href='/admin/productHistory'>
    <Box display='flex' my='5px' style={router.pathname == '/admin/productHistory' ? { textDecoration: "none", color: '#00ACEE' ,borderBottomWidth: '3px',background: '#E8F5FD' }
                    : { textDecoration: "none" }} _hover={{ background: '#E8F5FD', cursor: "pointer", color: '#00ACEE' }} zIndex={111}>
     <Center ml='5px' justifyContent={'center'} alignContent='center' h='50px' w='50px'>
...
<LinkNext href='/admin/report'>
    <Box display='flex' my='5px' style={router.pathname == '/admin/report' ? { textDecoration: "none", color: '#00ACEE' ,borderBottomWidth: '3px',background: '#E8F5FD' }
                    : { textDecoration: "none" }} _hover={{ background: '#E8F5FD', cursor: "pointer", color: '#00ACEE' }} zIndex={111}>
     <Center ml='5px' justifyContent={'center'} alignContent='center' h='50px' w='50px'>
...
<LinkNext href='/admin/category'>
    <Box display='flex' my='5px' style={router.pathname == '/admin/category' ? { textDecoration: "none", color: '#00ACEE' ,borderBottomWidth: '3px',background: '#E8F5FD' }
                    : { textDecoration: "none" }} _hover={{ background: '#E8F5FD', cursor: "pointer", color: '#00ACEE' }} zIndex={111}>
     <Center ml='5px' justifyContent={'center'} alignContent='center' h='50px' w='50px'>
