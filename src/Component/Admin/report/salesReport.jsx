...
export default function Dashboard() {
    ...
    async function getSales() {
        await axiosInstance.get("/order/all" , {
            params : filter,
        }).then((res)=>{
        ...
        >
            ...
            >
                <Heading
                    ...
                    letterSpacing="tight"
                >
                    Welcome back, <Flex display="inline-flex" fontWeight="bold">{userSelector.full_name}</Flex>
                </Heading>
                ...
                <Flex justifyContent="space-between" mt={8}>
                    <Flex align="flex-end">
                        <Heading as="h2" size="lg" letterSpacing="tight">Sales Report</Heading>
                    </Flex>
                    <Button>
                                ...
                                sales.Product_Orders?.map((val,index)=>
                                    <Tr >
                                        ...
                                        <Td>
                                            <Flex align="center">
                                                <Flex flexDir="column">
                                                    <Heading size="sm" letterSpacing="tight">{sales.User?.full_name}</Heading>
                                                </Flex>
                                            </Flex>
                                        </Td>
                                        ...
                                        <Flex align="center">
                                                <Flex flexDir="column">
                                                        ...
                                                        <Heading size="sm" letterSpacing="tight">{val?.Product?.name}</Heading>
                                       ...
                                       <Heading size = "sm"> {val.quantity} </Heading> 
                                        ...
                                        <Td>
                                        <Heading size="sm" color={"green"}>{sales.status}</Heading>
                                        </Td>
